...
\newcommand{\MacroF}{0.297}
\newcommand{\MacroP}{0.400}
\newcommand{\MacroR}{0.310}
% ---- ablations ------------------------------------------------------
...
($\ge0.70/\ge0.60$); the calibrated ensemble is \EnsVerdict{} (weights chosen
on the hold-out under the no-worse-than-best-single guard).
